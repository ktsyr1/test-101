...
function Header() {
    return (
        <div className="flex flex-row items-center justify-between px-4 mt-14 w-full">
            <h2 className="text-safety-700 text-6xl font-black my-4 max-[700px]:text-3xl ">المدونة</h2>
            <Link href="blog" className="flex flex-row justify-center items-center" >
                <p className="p-4 text-emerald-400 text-2xl max-[700px]:text-base font-normal">استكشف المدونة </p>
