...
export default function JobsPart({ className, title, to }: any) {
    return (
        <div className={`bg-slate-100  bg-[url(/images/bg-jobs.jpg)] bg-center w-full h-[940px] ${className} justify-center items-center flex p-0 m-0`}>
                ...
                <div className="w-full tap:m-auto flex flex-col justify-start rounded-3xl text-start tap:my-16 m-4">
                    ...
                    <div className="  bg-prussian-800 text-white tap:p-4 rounded-b-3xl w-full flex justify-start p-0 m-0 ">
                        <div className="flex flex-col tap:w-[50%] w-full">
                            ...
                            <Btn title={title ? title : "تعرف على آلية تقديم الطلبات"} to={to ? to : "/join"} className="bg-white tap:text-lg text-sm !justify-between  text-prussian-800 rounded-full m-4" childSort="end" >
