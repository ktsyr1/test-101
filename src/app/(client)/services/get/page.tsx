        ...
        <div className="flex flex-col justify-center items-center">
            ...
            <div className=" w-full flex flex-col   items-center max-w-[1200px] p-4 tap:max-w-[90%] ">
                <div className="mt-4 w-full m-auto bg-white">
                    ...
                    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLScedu-uK2yI5xFeTB0zgDCIwZCR9MVa9ygOkPhUSMGVzJ6tcA/viewform?embedded=true" className="m-auto border-0 max-w-[640px] w-full" height="800"    >جارٍ التحميل…</iframe>
