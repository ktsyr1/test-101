    ...
    return (
        <div className="bg-white">
            <Hero className={" bg-[url(/images/pinsel.jpeg)] min-h-[400px]"} >
                <>
                    <h1 className="text-white text-6xl font-semibold">المدونة</h1>
                    <p className="w-full m-auto text-2xl font-semibold my-0 p-4 max-w-[1000px]">هذا هو مركز الأخبار الخاص بنا، حيث نشارك خبرتنا ونصائحنا ومقالاتنا حول كل ما يتعلق بالعقارات، وكيفية البدء بالفحص، وكيفية تقييم ما إذا كنت بحاجة إلى واحدة أم لا.</p>
                    <p className="rounded-tl-[32px] text-2xl font-bold  rounded-br-3xl my-0 px-16 m-auto bg-white p-4 text-safety-700 w-max"> لكن أولاً، فنجان قهوة.</p>
                </>
            </Hero>
